...
public class ChipsRecognizerTest {
	...
	public void setUp() throws Exception {
		testObject = new ChipsRecognizer(chipsParser, imageProcessor);
	}
	...
	public void test() {
		...
		when(chipsParser.parseChips(bufferedImage)).thenReturn(100);
		...
		verify(chipsParser, times(6)).parseChips(bufferedImage);

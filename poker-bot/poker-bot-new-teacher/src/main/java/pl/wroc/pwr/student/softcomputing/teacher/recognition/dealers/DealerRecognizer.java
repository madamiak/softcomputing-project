...
public class DealerRecognizer implements Recognizer {
	private final ImageConverter imageConverter;
	private final OutputConverter outputConvert = new DealerOutputConverter();
	private NeuralNetwork neuralNetwork;

	public DealerRecognizer(ImageConverter imageConverter) {
